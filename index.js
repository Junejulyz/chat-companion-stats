  ...
  async function generateShareImage() {
    ...
    if (isClassicNight) {
      ...
      if (shareStyle === 'ins') {
        ...
        // iOS WebKit shift adjustment (nudged down slightly from 22 to 19 for perfect alignment)
        ctx.fillText(formattedDate, width / 2, 546 * scaleFactor - (isIOS ? 19 * scaleFactor : 0));
        ctx.textBaseline = 'alphabetic'; // Reset
