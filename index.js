...
jQuery(async () => {
  ...
  async function generateShareImage() {
    ...
    const insIcons = {
      heart: "M24.7725 7.15302C21.7346 7.15302 19.3444 8.79053 18 10.9997C16.6556 8.79053 14.2654 7.15302 11.2275 7.15302C6.67107 7.15302 3 10.8524 3 15.4497C3 21.464 12.3835 27.6015 17.5135 30.6974C17.8142 30.8789 18.1858 30.8789 18.4865 30.6974C23.6165 27.6015 33 21.464 33 15.4497C33 10.8524 29.3289 7.15302 24.7725 7.15302ZM18 28.5372C13.4398 25.6896 5 20.081 5 15.4497C5 11.967 7.79585 9.15302 11.2275 9.15302C13.8441 9.15302 15.8236 10.8719 16.5912 13.0483C16.7937 13.6219 17.352 14.0151 18 14.0151C18.648 14.0151 19.2063 13.6219 19.4088 13.0483C20.1764 10.8719 22.1559 9.15302 24.7725 9.15302C28.2042 9.15302 31 11.967 31 15.4497C31 20.081 22.5602 25.6896 18 28.5372Z",
      comment: "M31 18C31 25.1797 25.1797 31 18 31C16.0357 31 14.1738 30.5638 12.4925 29.7788L5 32L7.22123 24.5075C6.43615 22.8262 6 20.9643 6 18C6 10.8203 11.8203 5 19 5C26.1797 5 31 10.8203 31 18ZM29 18C29 11.9249 24.0751 7 18 7C11.9249 7 7 11.9249 7 18C7 20.2547 7.68065 22.3496 8.84758 24.0673C9.04351 24.3557 9.09689 24.7176 8.9893 25.0485L7.33333 30.1413L12.4261 28.4854C12.757 28.3778 13.1189 28.4311 13.4073 28.6271C15.125 29.794 17.2198 30.4747 18 30.4747C24.0751 30.4747 29 25.5498 29 18Z",
      ...
      bookmark: "M24 4.5H12C10.067 4.5 8.5 6.067 8.5 8V31.5C8.5 32.1969 8.90048 32.8105 9.5312 33.0827C10.1619 33.3549 10.892 33.2307 11.4142 32.7607L18 26.8335L24.5858 32.7607C25.108 33.2307 25.8381 33.3549 26.4688 33.0827C27.0995 32.8105 27.5 32.1969 27.5 31.5V8C27.5 6.067 25.933 4.5 24 4.5ZM25.5 30.3335L18.6657 24.1837C18.2831 23.8394 17.7169 23.8394 17.3343 24.1837L10.5 30.3335V8C10.5 7.17157 11.1716 6.5 12 6.5H24C24.8284 6.5 25.5 7.17157 25.5 8V30.3335Z",
